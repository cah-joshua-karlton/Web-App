...
export declare class MdbAutoCompleterComponent implements AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbAutoCompleterComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbAutoCompleterComponent, "mdb-auto-completer", ["mdbAutoCompleter"], { "clearButton": "clearButton"; "clearButtonTabIndex": "clearButtonTabIndex"; "visibleOptions": "visibleOptions"; "optionHeight": "optionHeight"; "dropdownHeight": "dropdownHeight"; "textNoResults": "textNoResults"; "appendToBody": "appendToBody"; "disabled": "disabled"; "displayValue": "displayValue"; }, { "select": "select"; "selected": "selected"; }, ["optionList", "mdbOptions"], ["*"]>;
}

...
export declare class ScrollSpyDirective implements OnInit, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ScrollSpyDirective, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ScrollSpyDirective, "[mdbScrollSpy]", never, { "id": "mdbScrollSpy"; }, { "activeLinkChange": "activeLinkChange"; }, ["links"], ["*"]>;
}

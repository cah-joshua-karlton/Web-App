...
export declare class SqueezeBoxComponent implements OnInit, AfterContentInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SqueezeBoxComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<SqueezeBoxComponent, "mdb-squeezebox, mdb-accordion", ["squeezebox"], { "autoExpand": "autoExpand"; "multiple": "multiple"; }, {}, ["items"], ["*"]>;
}

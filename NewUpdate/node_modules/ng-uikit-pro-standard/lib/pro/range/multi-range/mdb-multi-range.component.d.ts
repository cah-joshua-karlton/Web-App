...
export declare class MdbMultiRangeInputComponent implements OnInit, AfterViewInit, ControlValueAccessor {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbMultiRangeInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbMultiRangeInputComponent, "mdb-multi-range-input", never, { "value": "value"; "min": "min"; "max": "max"; "disabled": "disabled"; "id": "id"; "required": "required"; "name": "name"; "step": "step"; }, { "rangeValueChange": "rangeValueChange"; }, never, never>;
}

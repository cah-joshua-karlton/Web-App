...
export declare class MdbRangeInputComponent implements ControlValueAccessor, AfterViewInit {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MdbRangeInputComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MdbRangeInputComponent, "mdb-range-input", never, { "min": "min"; "max": "max"; "value": "value"; "disabled": "disabled"; "id": "id"; "required": "required"; "name": "name"; "step": "step"; "default": "default"; "defaultRangeCounterClass": "defaultRangeCounterClass"; }, { "rangeValueChange": "rangeValueChange"; }, never, never>;
}
